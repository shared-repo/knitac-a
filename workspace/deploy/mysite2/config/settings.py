...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'ohchihooooon.pythonanywhere.com']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ohchihooooon$pybo',         # 데이터베이스이름
        'USER': 'ohchihooooon',       # 아이디
        'PASSWORD': 'knitac',   # 패스워드
        'HOST': 'ohchihooooon.mysql.pythonanywhere-services.com',    # 서버 컴퓨터 IP
        'PORT': '3306'          # 서버 컴퓨터 포트
    }
}
